...
public class MyDateTimePickerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_date_time_picker);
        ...
        mDatePicker = new DatePickerDialog(MyDateTimePickerActivity.this,mDatePickerListener,
                mCalendar.get(Calendar.YEAR),
                mCalendar.get(Calendar.MONTH),
                mCalendar.get(Calendar.DATE));

        mTimePicker = new TimePickerDialog(MyDateTimePickerActivity.this,mTimePickerListener,
                mCalendar.get(Calendar.HOUR_OF_DAY),
                mCalendar.get(Calendar.MINUTE),
                true /* 24H Formtat Flag */);
